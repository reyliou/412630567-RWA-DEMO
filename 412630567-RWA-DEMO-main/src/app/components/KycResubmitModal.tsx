      ...
      <div className="relative z-10 bg-white w-full max-w-2xl rounded-[2.5rem] shadow-2xl border border-slate-100 overflow-hidden animate-in zoom-in-95 duration-300">
        ...
        <div className="px-8 py-6 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-black text-lg text-slate-800">
                {isSuccess ? "提交成功" : currentStatus === "REJECTED" ? "重新補繳 KYC 實名證件" : "上傳 KYC 實名認證雙證件"}
              </h3>
          ...
          <button
            ...
            className="p-2 hover:bg-slate-200 text-slate-400 hover:text-slate-700 rounded-xl transition-colors disabled:opacity-30"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
